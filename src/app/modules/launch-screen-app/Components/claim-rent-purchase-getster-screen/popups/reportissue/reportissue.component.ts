...
@Component({
  ...
  styleUrls: ['./reportissue.component.scss'],
})
export class ReportissueComponent implements OnInit {
  ...
  constructor(
    ...
    public ReportIssueDialogRef: MatDialogRef<ReportissueComponent>,
  ...
  getreportnumber(){
    this.table.getcliambooknewscreenuser(this.country_code,this.customer_id).subscribe((res)=>{
      console.log(res,'res');
