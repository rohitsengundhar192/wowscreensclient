...
@Component({
  selector: 'app-claim-rental-wavier-one',
  templateUrl: './claim-rental-wavier-one.component.html',
  styleUrls: ['./claim-rental-wavier-one.component.scss']
})
export class ClaimRentalWavierOneComponent implements OnInit {
//* --------------------------  Start  -----------------------------------*//
  ...
  //* ---------------------------  Constructor  ----------------------------*//
  constructor(
    public loginDialogRef: MatDialogRef<ClaimRentalWavierOneComponent>,
  ) {}
