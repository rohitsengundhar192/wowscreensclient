...
export const Calendar: React.FC<CalendarProps> = ({
  ...
  //   const separator: ReactChild = (
  //     <g key="separator" transform={`translate(${columnWidth * (dates.length + 1)}, 0)`}>
  //       {/* Adjust the translation values as needed to create the desired space */}
  //     </g>
  //   );
